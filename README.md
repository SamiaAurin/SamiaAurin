...
<!----       Stats  -->
<div align="center" style="background-color: #0f172a; color: #4fc3f7; padding: 20px; border-radius: 10px;">
  <!-- GitHub Profile Stats -->
  <img src="https://github-readme-stats.vercel.app/api?username=samiaaurin&hide_title=false&hide_rank=false&show_icons=true&include_all_commits=true&count_private=true&disable_animations=false&theme=algolia&locale=en&hide_border=true" height="180" alt="stats graph" style="margin: 10px; border-radius: 10px; border: 3px solid rgba(255, 255, 255, 0.7); box-shadow: 0 0 10px rgba(255, 255, 255, 0.5);" />
